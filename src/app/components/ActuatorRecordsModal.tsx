...
type Props = {
  open: boolean;
  actuadorId: string | null;
  onClose: () => void;
  onOpenProject?: (projectId: number) => void;
};

type SortField = 'valor' | 'timestamp' | 'proyectoNombre' | 'usuarioEmail';
...
export default function ActuatorRecordsModal({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/40 px-4">
      <div className="w-full max-w-6xl rounded-lg bg-white shadow-xl max-h-[90vh] flex flex-col">
        {/* Header */}
                    ...
                    {data.records.map((r, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-3 whitespace-nowrap text-sm">
                          <button
                            type="button"
                            onClick={() => onOpenProject?.(r.proyectoId)}
