...
export default function Header() {
  ...
  return (
    <header className="w-full bg-blue-800 text-white shadow-md px-6 py-3 flex items-center justify-between">
      {/* Izquierda: SIMMER (no prefijar BASE) */}
      <button
      ...
      <div className="flex items-center gap-3">
        {!loading && role === 'admin' && (
          ...
          >
            <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" className="opacity-90">
              <path d="M12 3l7 3v6c0 4.418-3.582 8-7 8s-7-3.582-7-8V6l7-3z" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
            </svg>
            <span>Admin</span>
          </button>
        )}
        ...
        >
          <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" className="opacity-90">
            ...
            <path d="M13 21H6a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          <span>Salir</span>
        </button>
      </div>
